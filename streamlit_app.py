...
with col1:
    ...
    st.write("Hello, I’m Praza, an Atmospheric and Planetary Sciences grad with a big interest in simulations, exoplanets, and using Python to dive into astronomy. I love exploring data to get new insights into how planets form and what’s out there in our universe.")
